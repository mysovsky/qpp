...
// ---------------------------------------------
  ...
  class buckingham_potential : public pair_potential<REAL,CELL>{
  public:
        
    REAL A, rho, C;
    
    using pair_potential<REAL,CELL>::atom1;
    using pair_potential<REAL,CELL>::atom2;
    using pair_potential<REAL,CELL>::rmax;
    ...
    typedef buckingham_potential<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<buckingham_potential<REAL,CELL>, pair_potential<REAL,CELL> >(m, pyname)
  ...
  template <class REAL, class CELL>
  class buckingham4_potential : public pair_potential<REAL,CELL>{
  public:
  ...
  public:
    ...
    typedef buckingham4_potential<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<buckingham4_potential<REAL,CELL>, pair_potential<REAL,CELL> >(m, pyname)
  ...
  template <class REAL, class CELL>
  class morse_potential : public pair_potential<REAL,CELL>{
  public:
    ...
    typedef morse_potential<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<morse_potential<REAL,CELL>, pair_potential<REAL,CELL> >(m, pyname)
	.def(py::init<const STRING_EX &, const STRING_EX &, REAL, REAL, REAL, REAL>())
  ...
  template <class REAL, class CELL>
  class cutcoulomb_potential : public pair_potential<REAL,CELL>{
  public:
    ...
    typedef cutcoulomb_potential<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<cutcoulomb_potential<REAL,CELL>, pair_potential<REAL,CELL> >(m, pyname)
  ...
  template <class REAL, class CELL>
  class spring_potential : public pair_potential<REAL,CELL>{
  public:
    ...
    using pair_potential<REAL,CELL>::atom2;
    using pair_potential<REAL,CELL>::rmax;
    using pair_potential<REAL,CELL>::too_close;
    ...
    typedef spring_potential<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<spring_potential<REAL,CELL>, pair_potential<REAL,CELL> >(m, pyname)
