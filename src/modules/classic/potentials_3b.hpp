...
namespace qpp{
  ...
  class three_harmonic : public potential_3body<REAL,CELL>{

    REAL theta0, k, k3, k4;
    
  public:
    
    using potential_3body<REAL,CELL>::atom1;
    using potential_3body<REAL,CELL>::atom2;
    using potential_3body<REAL,CELL>::atom3;
    using potential_3body<REAL,CELL>::r12max;
    using potential_3body<REAL,CELL>::r13max;
    ...
    typedef three_harmonic<REAL,CELL> SELF;
    
    static void py_export(py::module m, const char * pyname) {
      py::class_<three_harmonic<REAL,CELL>, potential_3body<REAL,CELL> >(m, pyname)
